              ...
              <div className="md:w-2/3 p-8">
                ...
                <div className="border-t pt-6">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li>• 2014年 - 株式会社ホームマート設立</li>
                    <li>• 2019年 - リフォーム部門開設</li>
                    <li>• 2022年 - URICO制度開始</li>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed">
              ...
              <p className="mb-6">
                おかげさまで、多くのお客様とのご縁に支えられ、ここ奈良で10年にわたり事業を続けてこられましたこと、心より感謝しております。
              </p>
              ...
              <p className="mb-6">
                例えば、使われなくなった空き家を再び人が集う住まいに蘇らせるリフォーム再販事業（URICO制度）にも力を入れております。それは地域の課題解決にも繋がり、奈良の街並みに新しい命を吹き込む仕事でもあります。
              </p>
              
              <p className="mb-6">
                これから家を売りたい方、買いたい方、リフォームしたい方——お客様それぞれに異なるご事情や夢がおありでしょう。私たちホームマートは、センチュリー21の一員として培った確かな知識とネットワーク、そして地元企業ならではの機動力と真心で、その夢の実現を全力でお手伝いいたします。
              ...
              <p className="text-yellow-600 font-semibold">
                今後ともセンチュリー21ホームマートをどうぞよろしくお願い申し上げます。
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-sm text-gray-500">9:00-22:00（水曜定休）</p>
            </div>
