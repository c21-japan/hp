...
export default function WhyChooseUs() {
  const strengths = [
    {
      title: '地域密着の安心サポート',
      description: '奈良県広陵町を拠点に、地域の不動産事情に精通したスタッフが、お客様一人ひとりに寄り添ったサービスを提供いたします。創業以来、地域のお客様との信頼関係を大切にし、不動産の売買・賃貸・リフォームまでワンストップでサポートいたします。',
      icon: MapPin,
      color: 'yellow',
      highlight: '地域密着・創業10年の実績'
    },
    {
      title: 'センチュリー21の全国ネットワーク',
      description: 'センチュリー21の全国ネットワークを活用し、地域に限定されない豊富な物件情報と、確かな取引実績を提供いたします。全国の加盟店との連携により、お客様のご希望に最適な物件をご紹介できます。',
      icon: Building,
      color: 'yellow',
      highlight: '全国ネットワーク・豊富な物件情報'
    },
    {
      title: '自社施工によるリフォーム',
      description: '不動産の売買だけでなく、自社施工によるリフォーム工事も承っております。熟練の職人による丁寧な施工と、アフターサービスまで安心してお任せいただけます。中古物件を購入してリフォームする「リノベーション」も人気です。',
      icon: Wrench,
      color: 'yellow',
      highlight: '自社施工・熟練職人による丁寧な施工'
    },
    {
